            ...
            <div class="col-lg-8 order-lg-1 ">
                ...
                <div class="card shadow mb-4 bg-dark">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" class="" action="{{ route('admin.agents.inviteStore', $referralToken) }}"
                            autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4  ">
                                ...
                                <div class="">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                <label class="form-control-label text-white" for="confirm_password">Confirm
                                                    password</label>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group focused">
                                            <label class="form-control-label text-white" for="new_password">Agent
                                                Commission</label>
                                            <input type="number" id="new_password" class="form-control" name="new_password"
                                                placeholder="Agent's Commission">
                                        </div>
                                    </div>
                                </div> --}}
                            </div>
