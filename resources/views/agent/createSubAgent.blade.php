        ...
        <div class="col-lg-8 order-lg-1 ">
            ...
            <div class="card shadow mb-4 bg-dark">
                ...
                <div class="card-header py-3 bg-dark">
                    <h6 class="m-0 font-weight-bold text-white">Sub-Agent's Account</h6>
                </div>
                        ...
                        <div class="pl-lg-4  ">
                            <div class="row ">
                                ...
                                <div>
                                    <div class="col-lg-4">
                                        <div class="form-group focused">
                                            <label class="form-control-label text-white" for="new_password">Agent Commission</label>
                                            <input type="number" id="new_password" class="form-control" name="new_password" placeholder="Agent's Commission">
                                        </div>
                                    </div>
                                </div>
                            </div>
